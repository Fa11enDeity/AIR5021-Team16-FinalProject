...
(cl:in-package spark_carry_object-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <scene-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'scene-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name spark_carry_object-srv:<scene-request> is deprecated: use spark_carry_object-srv:scene-request instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <scene-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader spark_carry_object-srv:type-val is deprecated.  Use spark_carry_object-srv:type instead.")
  (type m))

(cl:ensure-generic-function 'param-val :lambda-list '(m))
(cl:defmethod param-val ((m <scene-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader spark_carry_object-srv:param-val is deprecated.  Use spark_carry_object-srv:param instead.")
  (param m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<scene-request>)))
  ...
  "spark_carry_object/sceneRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'scene-request)))
  "Returns string type for a service object of type 'scene-request"
  "spark_carry_object/sceneRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <scene-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'scene-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name spark_carry_object-srv:<scene-response> is deprecated: use spark_carry_object-srv:scene-response instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <scene-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader spark_carry_object-srv:status-val is deprecated.  Use spark_carry_object-srv:status instead.")
  (status m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<scene-response>)))
  ...
  "spark_carry_object/sceneResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'scene-response)))
  "Returns string type for a service object of type 'scene-response"
  "spark_carry_object/sceneResponse")
